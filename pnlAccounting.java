...
public class pnlAccounting{
    

    public static void main(String[] args)throws Exception{

        String path = "C:/Java/jdk-18.0.1.1/"; //example path
        try {
		  ...
		  try {
            ...
            String[] filelist = new String[]{"examplepnl1","examplepnl2","examplepnl3","examplepnl4","examplepnl5"};
